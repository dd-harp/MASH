...
```{r figure_out_conversion}
health$previous_state
health_dt <- data.table(
  ID = health$previous_state$who,
  Start = ifelse(health$previous_state$disease == "I", 1, 0)
)
...
trajectory <- health$trajectory[1:health$trajectory_cnt]
tidx <- 1

...
This will run MBITES as a module within MASH. It begins as a copy of the latest `main()` for MASH, the `hook_only.Rmd` vignette.

```{r}
# install.packages(path_to_mbites, repos = NULL, type="source")
library(MBITES)
```

...
#'
#' @export
run_macro <- function(tmax, human_pars, mosquito_pars, patch_pars, model_pars, log_streams, vaxx_events, verbose = TRUE) {
    invisible(.Call('_macro_pfmoi_run_macro', PACKAGE = 'macro.pfmoi', tmax, human_pars, mosquito_pars, patch_pars, model_pars, log_streams, vaxx_events, verbose))
}

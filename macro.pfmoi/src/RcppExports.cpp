...
RcppExport SEXP _macro_pfmoi_run_macro(SEXP tmaxSEXP, SEXP human_parsSEXP, SEXP mosquito_parsSEXP, SEXP patch_parsSEXP, SEXP model_parsSEXP, SEXP log_streamsSEXP, SEXP vaxx_eventsSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    ...
    run_macro(tmax, human_pars, mosquito_pars, patch_pars, model_pars, log_streams, vaxx_events, verbose);
    return R_NilValue;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_macro_pfmoi_run_macro", (DL_FUNC) &_macro_pfmoi_run_macro, 8},
    {NULL, NULL, 0}
};

RcppExport void R_init_macro_pfmoi(DllInfo *dll) {
